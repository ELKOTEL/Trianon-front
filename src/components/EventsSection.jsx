      ...
      <div className="flex items-center justify-center max-w-6xl mx-auto p-4">
        ...
        <div className="w-1/2 pl-8 flex flex-col justify-center">
          <div className="text-[#5C4033]">
            <h2 className="text-4xl font-bold mb-4">Organize Your Meeting</h2>
          ...
          <div className="flex items-center justify-start mt-6 space-x-4">
            <button onClick={prevSlide} className="text-[#5C4033] text-2xl p-2 rounded-full bg-white shadow-lg">
              <FaArrowLeft />
            </button>
            <button onClick={nextSlide} className="text-[#5C4033] text-2xl p-2 rounded-full bg-white shadow-lg">
              <FaArrowRight />
            </button>
          </div>
        </div>
